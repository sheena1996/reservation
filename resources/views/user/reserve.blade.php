...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('reservations.store', $client->id) }}" method="POST" id="reserve">
                @csrf
                <div class="row">
                        ...
                        <div class="col-md-2 col-xs-12 align-self-center">
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control totalCost" name="total_cost" id="totalCost" placeholder="0">
                            </div>
                        </div>
                        <div class="col-md-2 col-xs-12 align-self-center">
                                                ...
                                                <td class="pl-3">
                                                    <div class="form-check productID">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="{{ $product->id }}" name="product_ID[]" type="checkbox" value="{{ $product->id }}" data-cost="{{ $product->cost }}">
